...
trait SugarCRMAware
{
    ...
    private static bool $serverInfoReceived = false;
    private static bool $licenseUpdated = false;
    ...
    public function applyLicense(): self
    {
        ...
        if ($license !== Config::DEFAULT_LICENSE && !self::$licenseUpdated) {
            $this
                ->loginAs('admin')
                ->bwcLogin()
                ->submitForm(
